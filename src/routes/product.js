...
router.get('/', guard.ensureLoggedIn(), async (req, res, next) => {
    ...
    res.render('product/manage', { expressFlash: req.flash('info'), products, branches, categories, layout: 'layouts/user' });
});


// router.get('/get-product', guard.ensureLoggedIn(), async (req, res, next) => {
